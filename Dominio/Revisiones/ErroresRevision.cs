...
{
    public static readonly string RevisionYaAprobada =
        "La revisión ya fue aprobada.";

    public static readonly string RevisionYaRechazada =
        "La revisión ya fue rechazada.";
